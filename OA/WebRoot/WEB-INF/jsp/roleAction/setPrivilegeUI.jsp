...
<%@ include file="/public/head.jspf"%>
    <script language="javascript" src="${oa}/script/jquery_treeview/jquery.treeview.js"></script>
	<link type="text/css" rel="stylesheet" href="${oa}/style/blue/file.css" />
	<link type="text/css" rel="stylesheet" href="${oa}/script/jquery_treeview/jquery.treeview.css" />
		...
		<div id="Title_bar_Head">
			...
			<div id="Title">
				...
				<img border="0" width="13" height="13"
					src="${oa}/style/images/title_arrow.gif" /> 配置权限
			</div>
	...
	<div id=MainArea>
		...
		<s:form action="roleAction_setPrivilege">
			...
			<div class="ItemBlock_Title1">
				...
				<div class="ItemBlock_Title1">
					<img border="0" width="4" height="7"
						src="${oa}/style/blue/images/item_point.gif" />
					正在为【${role.name}】配置权限
				</div>
			</div>
			...
			<div id="InputDetailBar">
				<input type="image" src="${oa}/style/images/save.png" /> <a
					href="javascript:history.go(-1);"><img
					src="${oa}/style/images/goBack.png" /></a>
			</div>
		</s:form>
	</div>
