...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${oa}/style/images/title_arrow.gif"/> 发表新主题
        </div>
				...
				<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
							...
							<table cellpadding="0" border="0" cellspacing="0">
								...
								<s:iterator begin="1" end="14" var="num">
									<td width="50" style="border-bottom:0 solid #ffffff">
										...
										<label for="r_${num}"><img width="19" height="19" src="${oa}/style/images/face/${num}.gif" disabled="true" align="absmiddle"/></label>
									</td>
								</s:iterator>
								</tr>
							</table></div>
					...
					<tr height="30">
						<td class="InputAreaBg" colspan="2" align="center">
							<input type="image" src="${oa}/style/blue/images/button/submit.PNG" style="margin-right:15px;"/>
							<a href="javascript:history.go(-1);"><img src="${oa}/style/blue/images/button/goBack.png"/></a>
						</td>
					</tr>
				</table>
			</div>
