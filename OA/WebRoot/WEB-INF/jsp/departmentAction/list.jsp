...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${oa}/style/images/title_arrow.gif"/> 部门管理
        </div>
...
<div id="MainArea">
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
            <s:a action="departmentAction_addUI?parentId=%{parentId}"><img src="${oa}/style/images/createNew.png" /></s:a>
