...
<head>
	...
	<link type="text/css" rel="stylesheet" href="${oa}/style/blue/forum.css" />
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${oa}/style/images/title_arrow.gif"/> 【${forum.name}】中的主题列表
        </div>
		...
		<div class="ItemBlock_Title1" style="width: 98%;">
			...
			<span style="margin-left:30px;">
				<s:a action="topicAction_addUI?forumId=%{#forum.id}">
					<img align="absmiddle" src="${oa}/style/blue/images/button/publishNewTopic.png"/>
				</s:a>
			</span>
		</div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr align="center" valign="middle">
					<td width="3" class="ForumPageTableTitleLeft">
						<img border="0" width="1" height="1" src="${oa}/style/images/blank.gif" />
					</td>
				...
				<s:iterator value="#topicList">
					<tr height="35" id="d0" class="template">
						<td></td>
						<td class="ForumTopicPageDataLine" align="center"><img src="${oa}/style/images/topicType_${type}.gif" /></td>
						<td class="Topic">
					...
					<table border="0" cellspacing="0" cellpadding="0" height="100%" align="left">
						<tr valign=bottom>
							...
							<td><select name="viewType">
								...
								<input type="IMAGE" src="${oa}/style/blue/images/button/submit.PNG" align="ABSMIDDLE"/>
							</td>
						</tr>
					</table>
				</div>
...
<div id=PageSelectorBar>
	...
	<div id=PageSelectorSelectorArea>
		<!--
		<IMG SRC="${oa}/style/blue/images/pageSelector/firstPage2.png"/>
		-->
		<a href="javascript:void(0)" title="首页" style="cursor: hand;">
			<img src="${oa}/style/blue/images/pageSelector/firstPage.png"/></a>
		...
		<!--
		<IMG SRC="${oa}/style/blue/images/pageSelector/lastPage2.png"/>
		-->
		<a href="#" title="尾页" style="cursor: hand;">
			<img src="${oa}/style/blue/images/pageSelector/lastPage.png"/></a>
